...
@onready var spear_1_audio: AudioStreamPlayer = $"sound fx/spear1_audio"
@onready var spear_2_audio: AudioStreamPlayer = $"sound fx/spear2_audio"
@onready var spear_3_audio: AudioStreamPlayer = $"sound fx/spear3_audio"
...
@export var max_guard := 100
@export var guard_stamina := 100
...
func _physics_process(delta):
	...
	# Always update target to the closest enemy
	if state != State.DEAD:
		acquire_target(delta)
...
# =====================================================
# ATTACK ANIMATION BASED ON TARGET POSITION
# =====================================================
