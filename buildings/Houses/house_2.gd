...
# Lancers
# ==================================================
var lancer_black := preload("res://unit/Monks/black monk.tscn")
var lancer_blue := preload("res://unit/Monks/blue monk.tscn")
var lancer_purple := preload("res://unit/Monks/purple monk.tscn")
var lancer_red := preload("res://unit/Monks/red monk.tscn")
var lancer_yellow := preload("res://unit/Monks/yellow monk.tscn")
