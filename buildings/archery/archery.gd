...
@onready var marker1: Marker2D = $Marker1
@onready var marker2: Marker2D = $Marker2
@onready var collision1: CollisionShape2D = $shape
...
# Lancers
# ==================================================
var lancer_black := preload("res://unit/Archers/archer_army black.tscn")
var lancer_blue := preload("res://unit/Archers/archer_army blue.tscn")
var lancer_purple := preload("res://unit/Archers/archer_army purple.tscn")
var lancer_red := preload("res://unit/Archers/archer_army red.tscn")
var lancer_yellow := preload("res://unit/Archers/archer_army yellow.tscn")
...
func spawn_lancers() -> void:
	...
	_spawn_lancers_around_marker(marker2.global_position, spawn_count - half, lancer_scene)
...
func apply_upgrades():
	...
	lancer_capacity = 4 + upgrade_levels.capacity * 1
